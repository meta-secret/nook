...
use nook_core::{
    DeviceIdentity, VaultCrypto, VaultKeys, VaultUnlock, genesis_auth_record,
...
fn genesis_projection_yaml(keys: &VaultKeys, identity: &DeviceIdentity) -> Result<String, String> {
...
#[test]
fn session_survives_provider_switch_simulation() -> Result<(), String> {
