...
class ArcManifestContract {
  ...
  async assert(): Promise<Result<void, OperationalContractFailure>> {
    ...
    const admittedContract28 = mainWorkflow.requireAll([
      ...
      "verification_outcome: ${{ steps.upload_web.outcome }}",
      "!cancelled() && needs.web.outputs.verification_outcome == 'success' && needs.web.outputs.cache_publication_outcome == 'success'",
