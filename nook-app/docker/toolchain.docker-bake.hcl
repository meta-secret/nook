...
// toolchain target: merges the two PARALLEL branches (nook-app/docker/toolchain.Dockerfile).
...
// nook-app/docker-bake.hcl adds the output/publish variants (toolchain / -cache / -push).
