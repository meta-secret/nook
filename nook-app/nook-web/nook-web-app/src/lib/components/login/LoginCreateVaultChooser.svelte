...
>
  <section
    class="mx-auto grid w-full max-w-6xl items-start gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-12"
  >
    <div class="space-y-5">
      <p
    ...
    <div>
      <div
        class="relative mb-8 hidden min-h-[12rem] place-items-center lg:grid"
      >
        <div
      ...
      <div
        class="rounded-xl border border-border bg-card/80 p-6 shadow-lg shadow-black/10 backdrop-blur-sm sm:p-8"
      >
        <ol class="space-y-4">
