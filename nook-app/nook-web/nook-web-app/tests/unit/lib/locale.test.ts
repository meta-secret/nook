...
describe('locale', () => {
  ...
  test('catalogs include architecture mode strings', () => {
    const modeKeys = [
      ...
      'architecture_modes.device_mode_standard_title',
      'architecture_modes.device_mode_standard_description',
      'architecture_modes.device_mode_anti-hacker_title',
      'architecture_modes.device_mode_anti-hacker_description',
