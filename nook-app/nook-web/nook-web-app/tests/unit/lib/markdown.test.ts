...
describe('renderMarkdown', () => {
  test('renders emphasis', () => {
    const html = markdownRenderer.renderMarkdown('Use **backup** code')
  ...
  test('does not pass through raw HTML', () => {
    const html = markdownRenderer.renderMarkdown('<script>alert(1)</script>')
  ...
  test('sanitizes malicious HTML injection and event handlers', () => {
    ...
    const html2 = markdownRenderer.renderMarkdown(
