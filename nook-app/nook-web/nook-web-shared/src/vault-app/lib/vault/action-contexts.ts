...
interface ProviderActionPorts extends SharedStorageActionsContext {
  ...
  handleRemoteVaultAssessStatus(accessStatus: VaultAccessStatus): Promise<boolean>
  loadDb(): Promise<void>
  persistProviders(
...
interface SyncActionPorts extends SharedStorageActionsContext {
  ...
  ensureOAuthTokensFresh(): Promise<Result<void, OAuthFailure | VaultStorageFailure>>
