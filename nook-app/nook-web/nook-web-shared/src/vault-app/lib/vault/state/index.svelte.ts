...
type VaultStateSlicesConstructor = {
  new (runtimeState: VaultRuntimeState): VaultStateSlicesBase & VaultStateSliceFields
}

export const VaultStateSlices = VaultStateSlicesBase as VaultStateSlicesConstructor
