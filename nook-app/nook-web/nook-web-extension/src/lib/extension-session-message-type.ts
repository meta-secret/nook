...
export const ExtensionSessionMessageType = {
  ...
  AuthenticatorEnrollPreview:
    'nook:extension-session-authenticator-enroll-preview',
  AuthenticatorEnrollCode: 'nook:extension-session-authenticator-enroll-code',
  AuthenticatorEnrollConfirm:
    'nook:extension-session-authenticator-enroll-confirm',
  AuthenticatorBackupAttach:
    'nook:extension-session-authenticator-backup-attach',
...
} as const satisfies Record<string, ExtensionSessionRequest['type']>

export type ExtensionSessionMessageType =
  (typeof ExtensionSessionMessageType)[keyof typeof ExtensionSessionMessageType]
