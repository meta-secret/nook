...
class ExtensionBuildDependencyLoader {
  ...
  async importSvelte(): Promise<
    Pick<typeof import('@sveltejs/vite-plugin-svelte'), 'svelte' | 'vitePreprocess'>
  > {
  ...
  > {
    ...
    const svelte: typeof import('@sveltejs/vite-plugin-svelte').svelte =
      (...parameters) => Reflect.apply(svelteFunction, value, parameters)
    const vitePreprocess:
      typeof import('@sveltejs/vite-plugin-svelte').vitePreprocess =
      (...parameters) =>
        Reflect.apply(preprocessFunction, value, parameters)
...
type WidgetLocaleMessageKey = keyof NookLocaleCatalogShape['extension']['widget']
type PasskeyLocaleMessageKey = keyof NookLocaleCatalogShape['extension']['passkey']
...
async function buildChromeLocales() {
  await Promise.all(
    ['en', 'ru'].map(async (locale) => {
      ...
      const messages = {
        widgetOpenVault: { message: catalog.extension.widget.message("open_vault", locale) },
        widgetDismiss: { message: catalog.extension.widget.message("dismiss", locale) },
        widgetCollapse: { message: catalog.extension.widget.message("collapse", locale) },
        widgetExpand: { message: catalog.extension.widget.message("expand", locale) },
        widgetPilotLabel: { message: catalog.extension.widget.message("pilot_label", locale) },
        widgetVaultConnected: {
          message: catalog.extension.widget.message("vault_connected", locale),
        },
        widgetVaultNotConnected: {
          message: catalog.extension.widget.message("vault_not_connected", locale),
        },
        widgetConnectVault: {
          message: catalog.extension.widget.message("connect_vault", locale),
        },
        widgetLoginTitle: { message: catalog.extension.widget.message("login_title", locale) },
        widgetLoginDescription: {
          message: catalog.extension.widget.message("login_description", locale),
        },
        widgetSignupTitle: { message: catalog.extension.widget.message("signup_title", locale) },
        widgetSignupDescription: {
          message: catalog.extension.widget.message("signup_description", locale),
        },
        widgetPasswordChangeTitle: {
          message: catalog.extension.widget.message("password_change_title", locale),
        },
        widgetPasswordChangeDescription: {
          message: catalog.extension.widget.message("password_change_description", locale),
        },
        widgetGeneratePassword: {
          message: catalog.extension.widget.message("generate_password", locale),
        },
        widgetGeneratePasswordWorking: {
          message: catalog.extension.widget.message("generate_password_working", locale),
        },
        widgetGeneratePasswordFailed: {
          message: catalog.extension.widget.message("generate_password_failed", locale),
        },
        widgetGeneratedPasswordFilled: {
          message: catalog.extension.widget.message("generated_password_filled", locale),
        },
        widgetUsePasskey: {
        ...
        widgetUsePasskeyWorking: {
          message: catalog.extension.widget.message("use_passkey_working", locale),
        },
        widgetCreatePasskeyWorking: {
          message: catalog.extension.widget.message("create_passkey_working", locale),
        },
        widgetPasskeyControlMissing: {
          message: catalog.extension.widget.message("passkey_control_missing", locale),
        },
        widgetPasskeyCeremonyStarted: {
          message: catalog.extension.widget.message("passkey_ceremony_started", locale),
        },
        widgetSaveLoginTitle: {
          message: catalog.extension.widget.message("save_login_title", locale),
        },
        widgetSaveLoginDescription: {
          message: catalog.extension.widget.message("save_login_description", locale),
        },
        widgetUpdateLoginTitle: {
          message: catalog.extension.widget.message("update_login_title", locale),
        },
        widgetUpdateLoginDescription: {
          message: catalog.extension.widget.message("update_login_description", locale),
        },
        widgetSaveLogin: { message: catalog.extension.widget.message("save_login", locale) },
        widgetUpdateLogin: { message: catalog.extension.widget.message("update_login", locale) },
        widgetSaveLoginNotNow: {
          message: catalog.extension.widget.message("save_login_not_now", locale),
        },
        widgetSaveLoginFailed: {
          message: catalog.extension.widget.message("save_login_failed", locale),
        },
        widgetSaveLoginSavedTitle: {
          message: catalog.extension.widget.message("save_login_saved_title", locale),
        },
        widgetSaveLoginSavedDescription: {
          message: catalog.extension.widget.message("save_login_saved_description", locale),
        },
        widgetTotpTitle: { message: catalog.extension.widget.message("totp_title", locale) },
        widgetTotpDescription: {
          message: catalog.extension.widget.message("totp_description", locale),
        },
        widgetManualTitle: { message: catalog.extension.widget.message("manual_title", locale) },
        widgetManualDescription: {
          message: catalog.extension.widget.message("manual_description", locale),
        },
        widgetTakeOver: { message: catalog.extension.widget.message("take_over", locale) },
        widgetFillingTitle: { message: catalog.extension.widget.message("filling_title", locale) },
        widgetVerifyingTitle: {
          message: catalog.extension.widget.message("verifying_title", locale),
        },
        widgetSubmitted: { message: catalog.extension.widget.message("submitted", locale) },
        widgetGateStep: { message: catalog.extension.widget.message("gate_step", locale) },
        widgetGateTitle: { message: catalog.extension.widget.message("gate_title", locale) },
        widgetGateDescription: {
          message: catalog.extension.widget.message("gate_description", locale),
        },
        widgetContinue: { message: catalog.extension.widget.message("continue", locale) },
        widgetWorking: { message: catalog.extension.widget.message("working", locale) },
        widgetUnlockThenContinue: {
          message: catalog.extension.widget.message("unlock_then_continue", locale),
        },
        widgetNoMatch: { message: catalog.extension.widget.message("no_match", locale) },
        widgetChooseAccount: {
          message: catalog.extension.widget.message("choose_account", locale),
        },
        widgetSavedLogin: { message: catalog.extension.widget.message("saved_login", locale) },
        widgetLoginPickerOpened: {
          message: catalog.extension.widget.message("login_picker_opened", locale),
        },
        widgetLoginPickerCanceled: {
          message: catalog.extension.widget.message("login_picker_canceled", locale),
        },
        widgetFillFailed: { message: catalog.extension.widget.message("fill_failed", locale) },
        widgetFilledManual: {
          message: catalog.extension.widget.message("filled_manual", locale),
        },
        widgetAuthenticatorStep: {
          message: catalog.extension.widget.message("authenticator_step", locale),
        },
        widgetAuthenticatorTitle: {
          message: catalog.extension.widget.message("authenticator_title", locale),
        },
        widgetAuthenticatorDescription: {
          message: catalog.extension.widget.message("authenticator_description", locale),
        },
        widgetFillAuthenticator: {
          message: catalog.extension.widget.message("fill_authenticator", locale),
        },
        widgetAuthenticatorWorking: {
          message: catalog.extension.widget.message("authenticator_working", locale),
        },
        widgetAuthenticatorUnlock: {
          message: catalog.extension.widget.message("authenticator_unlock", locale),
        },
        widgetNoAuthenticator: {
          message: catalog.extension.widget.message("no_authenticator", locale),
        },
        widgetAddAuthenticator: {
          message: catalog.extension.widget.message("add_authenticator", locale),
        },
        widgetChooseAuthenticator: {
          message: catalog.extension.widget.message("choose_authenticator", locale),
        },
        widgetSavedAuthenticator: {
          message: catalog.extension.widget.message("saved_authenticator", locale),
        },
        widgetAuthenticatorFillFailed: {
          message: catalog.extension.widget.message("authenticator_fill_failed", locale),
        },
        widgetAuthenticatorFilled: {
          message: catalog.extension.widget.message("authenticator_filled", locale),
        },
        widgetAuthenticatorPickerOpened: {
          message: catalog.extension.widget.message("authenticator_picker_opened", locale),
        },
        widgetAuthenticatorPickerCanceled: {
          message: catalog.extension.widget.message("authenticator_picker_canceled", locale),
        },
        widgetEnrollTitle: { message: catalog.extension.widget.message("enroll_title", locale) },
        widgetEnrollDescription: {
          message: catalog.extension.widget.message("enroll_description", locale),
        },
        widgetAddFromPage: { message: catalog.extension.widget.message("add_from_page", locale) },
        widgetSaveBackupCodes: {
          message: catalog.extension.widget.message("save_backup_codes", locale),
        },
        widgetEnrollWorking: {
          message: catalog.extension.widget.message("enroll_working", locale),
        },
        widgetEnrollUnsupported: {
          message: catalog.extension.widget.message("enroll_unsupported", locale),
        },
        widgetEnrollNoQr: { message: catalog.extension.widget.message("enroll_no_qr", locale) },
        ...
        widgetEnrollVerifyFilled: {
          message: catalog.extension.widget.message("enroll_verify_filled", locale),
        },
        widgetEnrollVerifyPending: {
          message: catalog.extension.widget.message("enroll_verify_pending", locale),
        },
        widgetEnrollSaved: { message: catalog.extension.widget.message("enroll_saved", locale) },
        widgetEnrollFailed: {
        ...
        widgetBackupTitle: { message: catalog.extension.widget.message("backup_title", locale) },
        widgetBackupDescription: {
          message: catalog.extension.widget.message("backup_description", locale),
        },
        widgetBackupWorking: {
          message: catalog.extension.widget.message("backup_working", locale),
        },
        widgetBackupEmpty: { message: catalog.extension.widget.message("backup_empty", locale) },
        widgetBackupReview: {
          message: catalog.extension.widget.message("backup_review", locale),
        },
        widgetBackupPaste: { message: catalog.extension.widget.message("backup_paste", locale) },
        widgetBackupConfirm: {
        ...
        widgetBackupSaved: { message: catalog.extension.widget.message("backup_saved", locale) },
        widgetBackupFailed: {
          message: catalog.extension.widget.message("backup_failed", locale),
        },
        widgetBackupChooseAuthenticator: {
          message: catalog.extension.widget.message("backup_choose_authenticator", locale),
        },
        widgetBackupModeReplace: {
          message: catalog.extension.widget.message("backup_mode_replace", locale),
        },
        widgetBackupModeMerge: {
          message: catalog.extension.widget.message("backup_mode_merge", locale),
        },
        passkeySaveTitle: { message: catalog.extension.passkey.message("save_title", locale) },
        passkeyUseTitle: { message: catalog.extension.passkey.message("use_title", locale) },
        passkeyUseBrowser: { message: catalog.extension.passkey.message("use_browser", locale) },
      }
