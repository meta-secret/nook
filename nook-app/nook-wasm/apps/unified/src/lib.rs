...
#[wasm_bindgen(start)]
pub fn start() {
    nook_wasm::configure_vault_application(nook_core::VaultApplication::UnifiedDevelopment);
}

#[wasm_bindgen(js_name = approveExtensionDevice)]
/// Approves an extension join through the unified development capability leaf.
///
/// # Errors
///
