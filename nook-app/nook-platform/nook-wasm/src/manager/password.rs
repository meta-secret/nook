...
mod wasm_tests {
    ...
    use nook_core::{
        Database, DeviceIdentity, DeviceMode, SecretId, SecretValue, SentinelPolicy, StorageMode,
        VaultArchitecture, VaultCrypto, VaultName, VaultNameRef, VaultStoreIdentityRef, VaultType,
        VaultVersionWrite,
    };
    use std::slice;
