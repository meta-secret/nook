...
pub mod multi_device_api {
    pub use crate::auth::multi_device::{
        ...
        VaultMetaState, app_id_from_public_key, approve_join_request, assess_connect_access,
        auth_record, build_members_records, count_sentinel_share_records,
        ...
        member_stored_key, merge_remote_join_records, parse_auth_envelopes, parse_join_request,
        parse_sentinel_share_envelope, pending_join_for_device, rename_vault_member,
        replace_member_records, resolve_dec, resolve_dek, resolve_member_roster,
