...
pub use auth::device_key_protection::{
    ...
    PasskeyAssertionRequest, PasskeyDeviceIdentityMaterial, PasskeyIdentityUnlock,
    PasskeyRecoveryInput, PasskeyRecoveryRequest, PasskeyRegistration, PasskeyRegistrationInput,
    ...
    WrappedDeviceIdentity, parse_wrapped_device_identity, passkey_derived_device_identity_record,
    passkey_wrapped_device_identity_record, serialize_wrapped_device_identity,
...
pub mod multi_device_api {
    pub use crate::auth::multi_device::{
        ...
        SelfRosterSync, SentinelParticipantEntry, SentinelShareEnvelope, SentinelShareVersion,
        VaultKeys, VaultMember, VaultMetaRecord, VaultMetaState, app_id_from_public_key,
        ...
        deny_join_request, device_id_from_public_key, device_is_enrolled, encrypt_member_entry,
        enroll_device_with_dec, enroll_device_with_keys, ensure_self_in_roster, generate_dec,
        ...
        join_record_key, list_join_requests, member_from_identity, member_from_join,
        member_stored_key, merge_remote_join_records, open_sentinel_share_for_identity,
        parse_auth_envelopes, parse_join_request, parse_sentinel_share_envelope,
        pending_join_for_device, reconstruct_sentinel_vault_keys,
