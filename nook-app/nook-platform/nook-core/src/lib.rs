...
pub use nook_companion_core::{
    ...
    VaultHostPolicyError, WebsitePasskeyProposal, authentication_form_observation_priority,
    authentication_page_observations_are_valid, belongs_to_sentinel_vault, belongs_to_simple_vault,
    classify_authentication_outcome, classify_authentication_workflow,
...
pub use multi_device::{
    ...
    event_graph_active_auth_ids, event_graph_has_active_device_access, generate_dec, generate_id,
