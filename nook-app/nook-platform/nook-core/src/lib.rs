...
pub use sync_provider_store::{
    ...
    ActiveVaultScope, AuthProvidersSnapshotData, DraftStorageConnection, DuplicateProviderId,
    DuplicateSyncProvider, GoogleOAuthTokenInput, ICloudOAuthTokenInput,
    LegacyAuthProvidersSnapshot, LocalFolderConfigData, LocalProviderRowChange,
    LocalProviderRowOutcome, LocalProviderRowRequest, ManagerStoreScopeRef, NormalizedAuthSnapshot,
    OAuthAccessToken, OAuthAccessTokenRef, OAuthFileConfigData, ProviderEnrollmentRequest,
    ProviderEventFlushTarget, ProviderLabelLabels, ProviderRows, ProviderSaveOutcome,
    ProviderSaveRequest, ProviderSaveSetup, ProviderSelection, ProviderSelectionPolicy,
    ...
    ProviderWireMigration, RemoteEventFlushProviderRequest, SharedGrantProviderSelection,
