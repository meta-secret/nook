...
pub use sync_provider_store::{
    ...
    LocalProviderSelection, ManagerStoreScopeRef, NormalizedAuthSnapshot, OAuthAccessToken,
    OAuthAccessTokenRef, OAuthFileConfigData, OAuthRemoteConfigurationUpdate,
