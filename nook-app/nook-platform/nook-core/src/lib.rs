...
pub use sync_provider_store::{
    ...
    AuthProvidersSnapshotData, GoogleOAuthTokenInput, ICloudOAuthTokenInput, LocalFolderConfigData,
    ManagerStoreScopeRef, NormalizedAuthSnapshot, OAuthAccessTokenRef, OAuthFileConfigData,
    ProviderLabelLabels, ProviderSaveOutcome, ProviderSaveRequest, ProviderSaveSetup,
    ProviderStorageDetailLabels, ProviderSyncCheckpoint, ProviderSyncRevision,
    ProviderSyncRevisionRef, ProviderSyncedVaultVersion, ProviderVaultScope, StorageConnectArgs,
    StorageProviderData, StoredGithubPat, StoredGithubRepository, StoredGoogleDriveFolder,
    ...
    StoredOAuthRemoteFileName, StoredOAuthTokenExpiry, active_provider_credentials_projection,
    active_vault_providers, auth_snapshot_legacy_storage_value, draft_storage_args,
    ...
    first_compatible_provider_id, local_provider_for_active_vault, localize_provider_label,
    normalize_auth_snapshot, provider_label_by_id, provider_onboarding_type,
    ...
    replace_active_vault_provider_grants, shared_grant_provider_id, staged_remote_storage_args,
    storage_args_for_provider, sync_providers_for_active_vault, update_provider_sync_metadata,
