...
pub use sync_provider_store::{
    ...
    NormalizedAuthSnapshot, OAuthAccessTokenRef, OAuthFileConfigData, ProviderLabelLabels,
    ProviderSaveOutcome, ProviderSaveRequest, ProviderSaveSetup, ProviderStorageDetailLabels,
    ...
    StoredOAuthTokenExpiry, active_vault_providers, apply_provider_save_policy,
