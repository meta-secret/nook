...
pub use sync_provider_store::{
    ...
    ProviderSyncRevisionRef, ProviderSyncedVaultVersion, ProviderVaultScope,
    ...
    active_vault_providers, auth_snapshot_legacy_storage_value, ensure_local_provider_row,
    find_duplicate_sync_provider, local_provider_for_active_vault, localize_provider_label,
    normalize_auth_snapshot, provider_label_by_id, provider_storage_detail, provider_target_key,
    providers_visible_while_device_locked, replace_active_vault_provider_grants,
    sync_providers_for_active_vault, update_provider_sync_metadata,
};
pub use validation::{
