...
pub use nook_companion_core::{
    ...
    AuthenticationEnrollmentEvidence, AuthenticationFormObservationPriority,
    AuthenticationManualCheckpoint, AuthenticationOutcomeDecision,
    AuthenticationOutcomeObservation, AuthenticationOutcomeVerdict, AuthenticationPageObservation,
    AuthenticationPageObservations, AuthenticationPageProgression, AuthenticationPasskeyEvidence,
    ...
    PageInputFieldObservation, PageInputType, VaultHostPolicyError, WebsitePasskeyProposal,
    authentication_page_observations_are_valid, belongs_to_sentinel_vault, belongs_to_simple_vault,
    classify_authentication_outcome, classify_authentication_workflow, expand_identity_text,
    ...
    looks_like_passkey_control_label, looks_like_username_field, matching_sentinel_vault_base_url,
    nook_vault_app_exclude_match_patterns, normalize_simple_vault_base_url,
    page_has_backup_code_hint, propose_website_passkey, resolve_oauth_origin_support,
...
pub use multi_device::{
    ...
    event_graph_active_auth_ids, event_graph_active_device_envelopes,
...
pub use sync_provider_store::{
    ...
    ActiveProviderCredentialsRequest, ActiveProviderLoginSetup, ActiveVaultScope,
    AuthProvidersSnapshotData, LocalFolderConfigData, ManagerStoreScopeRef, NormalizedAuthSnapshot,
    OAuthAccessTokenRef, OAuthFileConfigData, ProviderLabelLabels, ProviderSaveOutcome,
    ProviderSaveRequest, ProviderSaveSetup, ProviderStorageDetailLabels, ProviderSyncCheckpoint,
    ...
    active_provider_credentials_projection, active_vault_providers, apply_provider_save_policy,
    auth_snapshot_legacy_storage_value, bind_google_drive_shared_folder, draft_storage_args,
    ...
    local_provider_for_active_vault, localize_provider_label, normalize_auth_snapshot,
    oauth_remote_storage_ref, provider_label_by_id, provider_onboarding_type,
