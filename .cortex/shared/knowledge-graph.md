...
- [Shared knowledge contract](AGENTS.md)

Open one relevant category. Do not preload all shared documents.
...
- [Domain API integrity](../../.meta-cortex/skills/dev/coding-skill/practices/domain-api-integrity.md)
- [Function ownership](../../.meta-cortex/skills/dev/coding-skill/practices/function-ownership.md)
