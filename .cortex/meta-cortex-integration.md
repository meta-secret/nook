...
Nook pins Meta-Cortex 0.9.0. Each consuming worktree has its own ignored
...
separate operations; use the upstream [release notes](https://github.com/ai-ai-ai-ai-ai-ai-ai/meta-cortex/releases/tag/v0.9.0)
...
The Nook CLI release pin is 0.9.0. `preflight/Dockerfile` pins the installer
