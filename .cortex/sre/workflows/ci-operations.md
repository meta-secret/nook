...
See [pull-requests.md § Validation](../../workflows/pull-requests.md#5-hosted-iteration-and-explicit-validation)
and [coding-bro.md](../../workflows/coding-bro.md).
...
4. **Do** update this doc and [`pull-requests.md`](../../workflows/pull-requests.md) when workflow behavior changes.
...
See also: [ARCHITECTURE.md §7](../../ARCHITECTURE.md#7-the-engineering-harness), [pull-requests.md](../../workflows/pull-requests.md).
