...
10. **CI policy** — see subsections below. Agents: follow [pull-requests.md § Agent pipeline](../../workflows/pull-requests.md#agent-pipeline).
...
11. **GitHub Actions agent execution:**
    ...
    - See [remote-execution.md](remote-execution.md), [coding-bro.md](../../workflows/coding-bro.md), and [pull-requests.md § Validation](../../workflows/pull-requests.md#5-hosted-iteration-and-explicit-validation).
