...
* **Where to put it:** extend the relevant existing doc (`rules.md`, `design-docs/`, `workflows/`, `references/`). For recurring refactor or code-organization lessons, add or update a dynamic skill card under [`../dynamic-skills/`](../dynamic-skills/) and follow [dynamic-skills.md](../workflows/dynamic-skills.md). Add a new file only when the topic is substantial and has no natural home. Update [design-docs/index.md](index.md) or [AGENTS.md](../AGENTS.md) links when adding docs.
