...
| [identity-vault-architecture.md](identity-vault-architecture.md) | Identity management, vault independence, encrypted DEK grants, onboarding, and the shared replication-provider boundary | Local directory implemented |
