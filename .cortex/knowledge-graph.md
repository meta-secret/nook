...
the latter two is valid for the initial frontier. Prime creates new feature
work from `pinnedLocalDevSha` unless the user explicitly selects another base
and Prime records that choice. The existing canonical feature ref and
