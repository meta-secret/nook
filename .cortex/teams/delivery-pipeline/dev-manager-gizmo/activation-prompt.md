...
- .cortex/teams/delivery-pipeline/internal/pr-steward/workflows/authorization-handshake.md
...
status, and other GitHub-backed mechanic to Delivery Pipeline Team Gizmo under
an explicit packet for internal PR Steward.
...
Delivery Pipeline Team Gizmo to route internal PR Steward to publish the
selected committed snapshot with manager-only
...
delegate dev:pr-manager to Team Gizmo or internal PR Steward. Feature Gizmos,
Team Gizmos, and Team Agents never create or update PRs.
...
still equals it, and origin/main is its ancestor. Have internal PR Steward,
through Delivery Pipeline Team Gizmo, verify that remote main equals the
tested SHA and report actual PR state separately. Do
