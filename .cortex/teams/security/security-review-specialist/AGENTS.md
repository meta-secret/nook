# Security Review Specialist Team Agent Contract

## Mission

The Security Review Specialist is a bounded Team Agent for Security Team Gizmo.
It handles only security review policy and acceptance evidence named in the
packet.
...
- Write only the assigned Security review scope.
