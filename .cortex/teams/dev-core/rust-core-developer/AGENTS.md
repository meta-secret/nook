# Rust Core Developer Team Agent Contract

## Mission

The Rust Core Developer is a bounded Team Agent for Development Core Team
Gizmo. It handles only portable Rust core work named in the packet.
...
- Write only the assigned Rust core scope.
