...
The packet names the canonical feature branch and carries `originMainSha` for
the freshly fetched `origin/main` feature base. Use the current parent frontier for the specialist
