...
- **[cortex-writer.md](cortex-writer.md)**
  - **Purpose:** **P1 / critical `.cortex` writing rule**
    ...
    - Prohibit rendered Markdown tables.
    - Use enclosed lists for repeated fields or exact mappings.
- **[cortex-article-structure/SKILL.md](cortex-article-structure/SKILL.md)**
  - **Purpose:** **P1 / critical `.cortex` article rule**
    - Expose semantic Markdown hierarchy.
    - Prohibit authored HTML and rendered Markdown table nodes.
    - Put literal syntax in inline or block code.
...
5. Push the exact head and verify with `task remote TASK_NAME=loom:verify`.
