...
- **[vault-event-log.md](../../../teams/dev-core/design-docs/vault-event-log.md)**
  ...
  - Status: Implemented
- **[vault-architecture-modes.md](../../../teams/dev-core/design-docs/vault-architecture-modes.md)**
  - Description: Vault modes and identity-control architecture
  - Status: Implemented + target
- **[sentinel-genesis.md](../../../teams/dev-core/design-docs/sentinel-genesis.md)**
  - Description: Provider-free Sentinel reverse onboarding, threshold policy, and atomic genesis
  - Status: Implemented
- **[vault-schema-versioning.md](../../../teams/dev-core/design-docs/vault-schema-versioning.md)**
  - Description: #52 safe migration via event log; projection `schema_version`
  - Status: Implemented
- **[typed-newtypes.md](../../../teams/dev-core/design-docs/typed-newtypes.md)**
