...
- Mark status accurately in [`.cortex/product-specs/index.md`](../product-specs/index.md) (`Draft`, `Active`, `Implemented`, `Verified`, `Historical`).
...
- [ ] Update [`.cortex/product-specs/index.md`](../product-specs/index.md) status and description.
