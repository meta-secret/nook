...
- **[efficient-pr-delivery.md](efficient-pr-delivery.md)**
  - Purpose: Ship PRs with focused hosted execution, explicit complete validation, and exact-head readiness
...
- **[github-actions-only-validation.md](github-actions-only-validation.md)**
  - Purpose: Format locally; run focused tasks and complete gates explicitly on GitHub-hosted workers
