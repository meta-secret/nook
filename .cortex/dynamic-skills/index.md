...
|---|---|---|
| [code-review-comments.md](code-review-comments.md) | Handle comments already present without waiting for external review: verify, fix or explain, validate, push, reply on-thread, then resolve | [`.cursor/skills/code-review-comments/SKILL.md`](../../.cursor/skills/code-review-comments/SKILL.md) |
