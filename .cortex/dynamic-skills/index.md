...
| [typescript-single-parameter.md](typescript-single-parameter.md) | Loom only: every function/method takes at most one parameter; multi-value inputs use a typed object arg; enforced by ESLint `max-params` | [`.agents/skills/typescript-single-parameter/SKILL.md`](../../.agents/skills/typescript-single-parameter/SKILL.md) |
| [typescript-no-unknown.md](typescript-no-unknown.md) | Loom only: ban authored `unknown`; model untrusted YAML/JSON as `ExternalValue` / `ExternalObject`; enforced by ESLint `no-restricted-types` | [`.agents/skills/typescript-no-unknown/SKILL.md`](../../.agents/skills/typescript-no-unknown/SKILL.md) |
| [typescript-named-args.md](typescript-named-args.md) | Loom only: ban raw object-literal call arguments; assign a named typed args value first; enforced by ESLint `no-restricted-syntax` | [`.agents/skills/typescript-named-args/SKILL.md`](../../.agents/skills/typescript-named-args/SKILL.md) |
