...
| [typescript-no-unknown.md](typescript-no-unknown.md) | Model untrusted data with named external-value types | [`.agents/skills/typescript-no-unknown/SKILL.md`](../../.agents/skills/typescript-no-unknown/SKILL.md) |
