...
| [github-actions-only-validation.md](github-actions-only-validation.md) | Format locally; run focused tasks on the persistent Nook Actions pool and complete gates on GitHub-hosted workers | [`.agents/skills/github-actions-only-validation/SKILL.md`](../../.agents/skills/github-actions-only-validation/SKILL.md) |
