...
| [agent-feature-ownership.md](agent-feature-ownership.md) | Keep every agent inside its assigned feature and issue set; forbid mutation of another active task without an explicit handoff | [`.agents/skills/agent-feature-ownership/SKILL.md`](../../.agents/skills/agent-feature-ownership/SKILL.md) |
...
| [typescript-no-unknown.md](typescript-no-unknown.md) | Require domain values; confine generic transport values to immediate boundary narrowing | [`.agents/skills/typescript-no-unknown/SKILL.md`](../../.agents/skills/typescript-no-unknown/SKILL.md) |
| [typescript-named-args.md](typescript-named-args.md) | Require named typed values at object call boundaries | [`.agents/skills/typescript-named-args/SKILL.md`](../../.agents/skills/typescript-named-args/SKILL.md) |
