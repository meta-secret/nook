...
| [typescript-explicit-state.md](typescript-explicit-state.md) | Replace implicit `undefined` application state and parallel flags with discriminated unions; retain truthful structural absence only at boundaries and queries | |
