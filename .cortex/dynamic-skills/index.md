...
| [typescript-single-parameter.md](typescript-single-parameter.md) | Loom and migrated Nook web paths: authored functions take at most one parameter; multi-value inputs use a typed object arg | [`.agents/skills/typescript-single-parameter/SKILL.md`](../../.agents/skills/typescript-single-parameter/SKILL.md) |
| [typescript-no-unknown.md](typescript-no-unknown.md) | Loom and migrated Nook web paths: ban authored `unknown`; model untrusted data as a named external value | [`.agents/skills/typescript-no-unknown/SKILL.md`](../../.agents/skills/typescript-no-unknown/SKILL.md) |
| [typescript-named-args.md](typescript-named-args.md) | Loom and migrated Nook web paths: name and type object call arguments before passing them | [`.agents/skills/typescript-named-args/SKILL.md`](../../.agents/skills/typescript-named-args/SKILL.md) |
