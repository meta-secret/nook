...
| ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Toolchain base image    | `cache-from` pulled by **every** build (local + CI). **Main** publishes the verified `:latest` image + cache (`ci:main:publish` -> `toolchain-push`). PR CI and local dev never publish.                                                                            |
