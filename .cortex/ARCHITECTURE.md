...
| Rust crate dependencies | **cargo-chef** (`cook --all-targets` + `cook --clippy --all-targets`) and clippy/test warm-up during image build. Baked artifacts live at `/opt/nook/target`. |
