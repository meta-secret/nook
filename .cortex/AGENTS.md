...
- **Source file size limit (1,000 lines):** Every authored file, including Rust, stays at or below 1,000 lines. Oversized Rust signals excessive domain responsibility and requires cohesive architectural decomposition. See [dynamic-skills/source-file-size.md](dynamic-skills/source-file-size.md).
