...
/** @typedef {{baselineRefs: readonly string[], baselineWarnings?: readonly string[], job?: string, runId?: string | number, runAttempt?: string | number, environment?: NodeJS.ProcessEnv}} CollectTelemetryRequest */
/** @typedef {{refs: readonly string[], warnings: readonly string[]}} BuildHistoryBaseline */
