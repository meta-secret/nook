...
require_text "$remote" 'SCCACHE_S3_RW_MODE: READ_ONLY'
require_text "$compile_remote" 'SCCACHE_S3_RW_MODE'
...
require_text "$compile_remote" 'Dependency cache already exists; skipping duplicate dependency solve/export'
