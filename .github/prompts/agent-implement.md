...
5. If part of the request is too large, risky, blocked, or out of scope, follow
   ...
   Before removing implemented work, stop and hand off. The continuing owner
   must create a linked draft successor from the full-work commit and record
   its preservation inventory in Workbench.
