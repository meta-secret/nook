...
fn agent_implementation_claims_only_explicit_workbench_records() -> anyhow::Result<()> {
    ...
    for required in [
        ...
        "Required Workbench summary artifact is missing.",
    ...
    for required in [
        ...
        "Canonical feature branch advanced during bootstrap; adopting its latest fetched head and rerunning downstream evidence.",
