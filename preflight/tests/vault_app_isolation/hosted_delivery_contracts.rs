...
fn assert_hosted_buildkit_cache_contract(root: &Path) -> anyhow::Result<()> {
    ...
    for required in [
        ...
        "registry.nokey.sh/nook/buildcache/nook-rust-base-v1",
        "registry.nokey.sh/nook/buildcache/nook-rust-deps-v2",
        "registry.nokey.sh/nook/buildcache/${GHA_RUST_WASM_DEPS_SCOPE}",
        "registry.nokey.sh/nook/buildcache/nook-rust-native-source-v2",
        "registry.nokey.sh/nook/buildcache/nook-rust-wasm-source-v2",
        "registry.nokey.sh/nook/buildcache/nook-web-deps-v1",
        "registry.nokey.sh/nook/buildcache/nook-web-v1",
        "registry.nokey.sh/nook/buildcache/nook-web-e2e-v1",
        "type=registry,ref=",
