  ...
  [
    {
      ...
      requiredMarkers: [
        ...
        'No internal cryptographic receipt, replay gate, or result-authority token belongs in this registry.',
      ],
    },
    {
    ...
    },
    {
      ...
      requiredMarkers: [
        ...
        'This is a typed task and result handoff. It does not require signatures, anti-forgery checks, replay gates, digests, one-use capabilities, or duplicate verification between trusted Team Gizmos and Team Agents.',
        'The parent still reviews the ordinary result before assigning edits.',
      ],
    },
    {
  ...
  [
    {
      ...
      requiredMarkers: [
        ...
        'No signature, anti-forgery check, replay gate, digest, one-use capability, or duplicate verification is required between trusted peers.',
  ...
  [
    ...
    },
    {
      ...
      requiredMarkers: [
        ...
        'The trusted in-thread handoff does not require signatures, anti-forgery checks, replay gates, digests, one-use capabilities, or duplicate verification.',
