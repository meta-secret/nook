...
const MAX_BUFFERED_TEAM_PLAN_RECORD_REQUEST_BYTES = 16 * 1024 * 1024;
export const MAX_TEAM_PLAN_RECORD_REQUEST_BYTES = Math.min(
  MAX_SERIALIZED_TEAM_PLAN_RECORD_BYTES + 1,
  MAX_BUFFERED_TEAM_PLAN_RECORD_REQUEST_BYTES,
);
