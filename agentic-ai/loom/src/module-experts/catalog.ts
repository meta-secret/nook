...
const INTERNAL_API_EXPERT_AUTHORED_CONSUMER_SCOPE_PATHS = [
  ...
  'nook-app/nook-web/nook-web-extension/src/lib/auth-widget-policy.ts',
  ...
  'nook-app/nook-web/nook-web-shared/src/vault-app/lib/components/devices-access/AccessDeviceKeyPanel.svelte',
  'nook-app/nook-web/nook-web-shared/src/vault-app/lib/components/devices-access/AccessUnlockPanel.svelte',
  ...
  'nook-app/nook-web/nook-web-shared/src/vault-app/lib/components/devices-access/passkey-evidence-labels.ts',
