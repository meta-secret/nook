...
const INTERNAL_API_EXPERT_AUTHORED_CONSUMER_SCOPE_PATHS = [
  ...
  'nook-app/nook-web/nook-web-extension/src/content/autofill/authentication-activity-progress.ts',
  'nook-app/nook-web/nook-web-extension/src/content/autofill/authenticator-actions.ts',
  'nook-app/nook-web/nook-web-extension/src/content/autofill/backup-code-workflow-action.ts',
  'nook-app/nook-web/nook-web-extension/src/content/autofill/enrollment-action-presentation.ts',
  'nook-app/nook-web/nook-web-extension/src/content/autofill/login-credential-fill-action.ts',
  'nook-app/nook-web/nook-web-extension/src/content/autofill/login-passkey-action-types.ts',
  ...
  'nook-app/nook-web/nook-web-extension/src/content/autofill/widget-presentation-state.ts',
  'nook-app/nook-web/nook-web-extension/src/content/autofill/widget-rendering.ts',
  'nook-app/nook-web/nook-web-extension/src/content/autofill/widget-workflow-key.ts',
  'nook-app/nook-web/nook-web-extension/src/content/autofill/workflow-revalidation.ts',
  ...
  'nook-app/nook-web/nook-web-extension/src/lib/enrollment-messages.ts',
  ...
  'nook-app/nook-web/nook-web-extension/src/lib/login-fill-messages.ts',
  ...
  'nook-app/nook-web/nook-web-extension/src/lib/simple-vault-runtime.ts',
  ...
  'nook-app/nook-web/nook-web-extension/src/offscreen/session-key-material.ts',
  ...
  'nook-app/nook-web/nook-web-shared/src/extension/authentication-submission-semantics.ts',
  ...
  'nook-app/nook-web/nook-web-shared/src/extension/extension-connect-types.ts',
  ...
  'nook-app/nook-web/nook-web-shared/src/extension/paired-vault-identity-status.ts',
  ...
  'nook-app/nook-web/nook-web-shared/src/vault-app/lib/components/ProviderVaultDecisionPanel.svelte',
  ...
  'nook-app/nook-web/nook-web-shared/src/vault-app/lib/components/devices-access/identity-session-transition.ts',
  ...
  'nook-app/nook-web/nook-web-shared/src/vault-app/lib/components/login/LoginVaultIdentityContext.svelte',
  ...
  'nook-app/nook-web/nook-web-shared/src/vault-app/lib/components/login/login-create-vault-chooser-contract.ts',
  'nook-app/nook-web/nook-web-shared/src/vault-app/lib/components/login/login-vault-identity-context.ts',
  'nook-app/nook-web/nook-web-shared/src/vault-app/lib/components/login/sentinel-card-stack-contract.ts',
  'nook-app/nook-web/nook-web-shared/src/vault-app/lib/components/login/sentinel-dashboard-surface-contract.ts',
  ...
  'nook-app/nook-web/nook-web-shared/src/vault-app/lib/extension/extension-response-decoders.ts',
  'nook-app/nook-web/nook-web-shared/src/vault-app/lib/extension/vault-approval.ts',
  ...
  'nook-app/nook-web/nook-web-shared/src/vault-app/lib/runtime/storage-failure.ts',
  ...
  'nook-app/nook-web/nook-web-shared/src/vault-app/lib/vault/identity-handoff.ts',
  ...
  'nook-app/nook-web/nook-web-shared/src/vault-app/lib/vault/secret-operation-failure.ts',
