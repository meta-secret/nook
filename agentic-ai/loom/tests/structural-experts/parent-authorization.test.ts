...
export class StructuralExpertsParentAuthorizationScenario {
  private constructor(private readonly request: EvidenceRequestInput) {}

  static evidenceRequest(
    input: EvidenceRequestInput,
  ): StructuralEvidenceInvocationRequest {
    return new StructuralExpertsParentAuthorizationScenario(input).execute();
  }

  private execute(): StructuralEvidenceInvocationRequest {
    ...
    return {
      ...
      attempt: 1,
      depth: 2,
      parent: StructuralExpertsParentAuthorizationScenario.parentIdentity(),
      instruction: 'Inspect the exact bounded surface.',
      evidencePaths: input.evidencePaths,
    };
  }

  static synthesisInvocation(
  ...
  static expectedProjections(): readonly StructuralChildProjection[] {
    const decodedCodeEvidence = WorkflowResultSchema.decodeWorkflowTaskOutput(
      JSON.stringify(
        StructuralExpertsParentAuthorizationScenario.codeEvidence(),
      ),
    );
    ...
    const codeInput: ChildProjectionInput = {
      ...
      resultSha256: StructuralExpertsParentAuthorizationScenario.hash(
        `${JSON.stringify(codeTerminal)}\n`,
      ),
      viewSha256: StructuralExpertsParentAuthorizationScenario.hash(
        `${StructuralExpertsParentAuthorizationScenario.codeEvidence().materializedViewMarkdown}\n`,
      ),
    };
    const cortexInput: ChildProjectionInput = {
      ...
      resultSha256: StructuralExpertsParentAuthorizationScenario.hash(
        `${JSON.stringify(failedTerminal)}\n`,
      ),
      viewSha256: StructuralExpertsParentAuthorizationScenario.hash(
        StructuralExpertsParentAuthorizationScenario.failedView(),
      ),
    };
    return [
      StructuralExpertsParentAuthorizationScenario.childProjection(codeInput),
      StructuralExpertsParentAuthorizationScenario.childProjection(cortexInput),
    ];
  }

  static childProjection(
  ...
  static async createRootPlan(input: RootPlanInput): Promise<void> {
    const authorizations: StructuralExpertAuthorization[] = [
      StructuralExpertsParentAuthorizationScenario.evidenceAuthorization(
        input.codeRequest,
      ),
      StructuralExpertsParentAuthorizationScenario.evidenceAuthorization(
        input.cortexRequest,
  ...
  static async invokeWithRuntime(input: InvokeWithRuntimeInput): Promise<void> {
    ...
    return {
      ...
      continuation: {
        ...
        architectureFindings:
          StructuralExpertsParentAuthorizationScenario.noFindings(),
        designFindings:
          StructuralExpertsParentAuthorizationScenario.noFindings(),
        codeQualityFindings:
          StructuralExpertsParentAuthorizationScenario.noFindings(),
        typeSafetyFindings:
          StructuralExpertsParentAuthorizationScenario.noFindings(),
        testFindings: StructuralExpertsParentAuthorizationScenario.noFindings(),
  ...
  static synthesisOutput(): SystemCoherenceTaskOutput {
...
test('binds and consumes an exact mixed all-terminal synthesis barrier', async () => {
  ...
  const runDirectory =
    StructuralExpertsParentAuthorizationScenario.processingRunDirectory(runId);
  ...
  const codeRequest =
    StructuralExpertsParentAuthorizationScenario.evidenceRequest(codeInput);
  ...
  const cortexRequest =
    StructuralExpertsParentAuthorizationScenario.evidenceRequest(cortexInput);
  try {
    const rootInput: RootPlanInput = {
      ...
      cortexRequest,
      synthesisChildLanes: [
        StructuralExpertsParentAuthorizationScenario.childLane(codeRequest),
        StructuralExpertsParentAuthorizationScenario.childLane(cortexRequest),
      ],
    };
    await StructuralExpertsParentAuthorizationScenario.createRootPlan(
      rootInput,
    );
    ...
    await StructuralExpertsParentAuthorizationScenario.invokeWithRuntime(
      codeInvocation,
    );
    ...
    const projections =
      StructuralExpertsParentAuthorizationScenario.expectedProjections();
    const synthesisInput: SynthesisInvocationInput = {
      runId,
      childProjections: projections,
    };
    const synthesisRequest =
      StructuralExpertsParentAuthorizationScenario.synthesisInvocation(
        synthesisInput,
      );
    ...
    await expect(
      StructuralExpertParentAuthorization.verifyStructuralParentAuthorization(
        reboundVerification,
      ),
...
test('rejects omitted, extra, reordered, or unrelated synthesis lanes', async () => {
  ...
  const plannedProjections = [
    ...projections,
    StructuralExpertsParentAuthorizationScenario.childProjection(thirdInput),
  ];
  try {
    const rootInput: RootPlanInput = {
      runId,
      codeRequest,
      cortexRequest,
      synthesisChildLanes: plannedProjections.map(
        StructuralExpertsParentAuthorizationScenario.projectionLane,
      ),
    };
    await StructuralExpertsParentAuthorizationScenario.createRootPlan(
      rootInput,
    ...
    const variants = [
      ...
      [
        ...plannedProjections,
        StructuralExpertsParentAuthorizationScenario.childProjection(
          unrelatedInput,
        ),
      ],
    ];
